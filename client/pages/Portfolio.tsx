...
export default function Portfolio() {
  ...
  const projects = [
    {
      ...
      description: "Complete mobile shopping experience redesign that increased conversion rates by 45% and improved user satisfaction scores.",
      challenge: "The existing mobile app had a 23% cart abandonment rate and poor user reviews citing confusing navigation and lengthy checkout process.",
      solution: "Redesigned the entire user flow with simplified navigation, one-tap checkout, and personalized product recommendations based on user behavior analysis.",
      results: [
    ...
    },
    {
      ...
      image: "/placeholder.svg",
      thumbnail: "/placeholder.svg",
      description: "Modern dashboard interface for data analytics platform with improved user flow and data visualization.",
      challenge: "Complex data visualization was overwhelming users, leading to low feature adoption and high churn rates.",
      solution: "Created a clean, modular dashboard with customizable widgets, progressive disclosure, and intelligent data insights.",
      results: [
    ...
    },
    {
      ...
      image: "/placeholder.svg",
      thumbnail: "/placeholder.svg",
      description: "Complete brand identity including logo, color palette, typography, and comprehensive design guidelines.",
      challenge: "Startup needed a modern, professional brand identity that would appeal to both B2B clients and investors.",
      solution: "Developed a sophisticated brand system with flexible logo variations, modern color palette, and comprehensive brand guidelines.",
      results: [
    ...
    },
    {
      ...
      image: "/placeholder.svg",
      thumbnail: "/placeholder.svg",
      description: "Patient-centric portal design focusing on accessibility, ease of use, and secure health information management.",
      challenge: "Existing portal was not accessible to elderly patients and those with disabilities, causing frustration and low adoption.",
      solution: "Redesigned with WCAG 2.1 AA compliance, large touch targets, clear typography, and simplified navigation patterns.",
      results: [
    ...
    },
    {
      ...
      image: "/placeholder.svg",
      thumbnail: "/placeholder.svg",
      description: "Modern mobile banking experience with advanced security features and intuitive financial management tools.",
      challenge: "Traditional banking app was outdated and lacked modern features that younger customers expected.",
      solution: "Created a fresh, security-first mobile banking experience with biometric authentication and AI-powered insights.",
      results: [
    ...
    },
    {
      ...
      image: "/placeholder.svg",
      thumbnail: "/placeholder.svg",
      description: "Comprehensive design system with reusable components, clear documentation, and implementation guidelines.",
      challenge: "Large enterprise had inconsistent UI across 50+ products, leading to poor user experience and high development costs.",
      solution: "Built a scalable design system with atomic design principles, comprehensive documentation, and developer tools.",
      results: [
  ...
  const categories = [
    ...
    { id: "design-system", name: "Design Systems", count: projects.filter(p => p.category === "design-system").length }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 animate-slide-in-left">
              ...
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                A collection of my best work showcasing user-centered design solutions
                across mobile apps, web platforms, and brand identities.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-6 mb-8">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-semibold text-foreground">Featured Projects</div>
                    <div className="text-sm text-muted-foreground">Hand-picked showcase</div>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 bg-primary-100 rounded-xl flex items-center justify-center">
                  ...
                  <div>
                    <div className="font-semibold text-foreground">Total Projects</div>
                    <div className="text-sm text-muted-foreground">Since 2021</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-6 animate-slide-in-right">
              <div className="bg-white/50 backdrop-blur-sm rounded-2xl p-8 border border-primary/10 shadow-xl">
                  ...
                  <div className="space-y-4">
                    <div className="skill-item">
                      <div className="flex justify-between text-sm mb-2">
                        ...
                        <span className="skill-percentage text-primary font-bold">95%</span>
                      </div>
                      <div className="w-full bg-primary/10 rounded-full h-2">
                        <div className="skill-bar skill-bar-1 bg-gradient-to-r from-primary-500 to-primary-600 h-2 rounded-full" style={{width: '0%'}}></div>
                      </div>
                    </div>
                    <div className="skill-item">
                      <div className="flex justify-between text-sm mb-2">
                        <span className="font-medium">User Research</span>
                        <span className="skill-percentage text-primary font-bold">90%</span>
                      </div>
                      <div className="w-full bg-primary/10 rounded-full h-2">
                        <div className="skill-bar skill-bar-2 bg-gradient-to-r from-primary-500 to-primary-600 h-2 rounded-full" style={{width: '0%'}}></div>
                      </div>
                    </div>
                    <div className="skill-item">
                      <div className="flex justify-between text-sm mb-2">
                        <span className="font-medium">Prototyping</span>
                        <span className="skill-percentage text-primary font-bold">92%</span>
                      </div>
                      <div className="w-full bg-primary/10 rounded-full h-2">
                        <div className="skill-bar skill-bar-3 bg-gradient-to-r from-primary-500 to-primary-600 h-2 rounded-full" style={{width: '0%'}}></div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="border-t border-primary/10 pt-6">
                  <h4 className="font-semibold text-foreground mb-4">UX Impact Metrics</h4>
                  <div className="grid grid-cols-3 gap-4">
                    <div className="text-center">
                      <div className="counter-animation text-2xl font-bold text-primary mb-1" data-target="45">0%</div>
                      <div className="text-xs text-muted-foreground">Conversion<br/>Increase</div>
                    </div>
                    <div className="text-center">
                      <div className="counter-animation text-2xl font-bold text-primary mb-1" data-target="60">0%</div>
                      <div className="text-xs text-muted-foreground">Task<br/>Completion</div>
                    </div>
                    <div className="text-center">
                      <div className="counter-animation text-2xl font-bold text-primary mb-1" data-target="30">0%</div>
                      <div className="text-xs text-muted-foreground">Time<br/>Reduction</div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 animate-slide-up">
            ...
            <p className="text-lg text-muted-foreground">
              Explore my complete portfolio with filtering and search capabilities.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="animate-slide-up">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              I'm always excited to take on new challenges and create exceptional 
