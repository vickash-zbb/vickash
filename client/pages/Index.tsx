...
export default function Index() {
  ...
  const portfolioItems = [
    {
      ...
      image: "/tharunam.png",
      description:
        "Engineered a complete mobile shopping experience, resulting in a more intuitive navigation and a seamless checkout process.",
    ...
    },
    {
      ...
      description:
        "Designed a modern dashboard interface for a data analytics platform, which significantly improved user flow and data comprehension.",
    ...
    },
    {
      ...
      image: "/timesmart.png",
      description:
        "Developed a complete brand identity, including a new logo, color palette, and design guidelines, leading to a 40% increase in brand recognition.",
    ...
    },
    {
      ...
      description:
        "Created a patient-centric mobile app design with a focus on accessibility and ease of use, resulting in a 95% user satisfaction rate.",
    ...
    },
    {
      ...
      description:
        "Led the redesign of a corporate website, which resulted in a 30% increase in conversion rates and higher user engagement.",
    ...
    },
    {
      ...
      description:
        "Built a comprehensive design system from the ground up, which increased development velocity by 50%.",
  ...
  const services = [
    {
      ...
      title: "UI/UX Design",
      description:
        "I craft intuitive and visually compelling user interfaces that elevate the user experience and drive engagement.",
      features: [
    ...
    },
    {
      ...
      title: "User Research",
      description:
        "I uncover valuable user insights through comprehensive research to inform design decisions and enhance usability.",
      features: [
    ...
    },
    {
      ...
      description:
        "I build and maintain scalable design systems that ensure brand consistency and streamline product development.",
      features: [
        "Component Libraries",
    ...
    },
    {
      ...
      description:
        "I help define and validate product direction through user testing and data analysis to ensure we're building the right thing.",
      features: [
        "A/B Testing",
  ...
  const testimonials = [
    {
      ...
      content:
        "Vickash is a design powerhouse. He delivered an exceptional UI/UX design that significantly improved our user engagement. His attention to detail and user-centric approach are second to none.",
      rating: 5,
    },
    {
      id: 2,
      ...
      image: "/placeholder.svg",
      content:
        "Working with Vickash was a game-changer for our product. He has a unique ability to understand a complex vision and transform it into an intuitive, beautiful, and highly effective user interface.",
      rating: 5,
    },
    {
      id: 3,
      ...
      image: "/placeholder.svg",
      content:
        "Vickash's design expertise was instrumental in creating a cohesive brand identity that truly resonated with our target audience. I can't recommend him enough!",
      rating: 5,
    },
  ];
  ...
  const coreSkills = [
    ...
    },
    {
      name: "UX Design",
      icon: UsersIcon,
      description: "Designing user-centered experiences and journeys",
    },
    {
      name: "Prototyping",
      icon: Layers,
    ...
    },
    {
      ...
      icon: Smartphone,
      description: "Mobile-first and cross-platform design approach",
    },
    {
      name: "User Research",
      icon: Search,
    ...
    },
    {
      ...
      icon: TestTube,
      description: "Validating designs through user feedback and testing",
    },
    {
      name: "Visual Design",
      icon: Palette,
      description: "Creating cohesive visual systems and branding",
    },
  ];
  ...
  return (
    <Layout>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div
          className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-primary-300/15 rounded-full blur-3xl animate-float"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="animate-slide-up">
            <Badge
              variant="outline"
              className="mb-6 px-4 py-2 text-primary border-primary/20 bg-primary/5"
            >
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
              Hi, I'm <strong>Vickash Shivan</strong>. I design and build
              beautiful, intuitive, and results-driven digital experiences that
              users love.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-slide-in-left">
              ...
              <h2 className="text-3xl md:text-4xl font-display font-bold mb-6">
                Designing with Purpose, Creating with{" "}
                <span className="text-primary">Passion</span>
              </h2>

              <div className="space-y-4 text-muted-foreground mb-8">
                <p>
                  For over three years, I've been immersed in the world of UI/UX
                  design, helping businesses translate their ideas into
                  exceptional digital products. My passion lies in creating
                  experiences that are not only visually stunning but also
                  intuitive, accessible, and highly functional.
                </p>
                <p>
                  I combine deep user research, creative problem-solving, and a
                  meticulous attention to detail to deliver designs that not
                  only meet business goals but also foster user loyalty and
                  satisfaction.
                </p>
                <p>
                  I believe that great design is about more than just
                  aesthetics; it's about solving problems so elegantly that the
                  solution feels effortless. That's the standard I bring to
                  every project.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button className="bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 w-auto">
                  <a
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-slide-up">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
              Here's a curated selection of my work, demonstrating my ability to
              solve complex problems with creative, user-centric solutions
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              My toolkit is a curated collection of the industry's best,
              enabling me to craft exceptional user-focused digital experiences
            ...
            <div>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        <div
                          className={`w-10 h-10 rounded-lg bg-gradient-to-r ${tool.color} flex items-center justify-center group-hover:scale-110 transition-transform`}
                        >
              ...
              <div className="mt-6 space-y-3">
                <div className="flex flex-wrap gap-2">
                  ...
                  <Badge
                    variant="secondary"
                    className="bg-neural/10 text-neural border-neural/20"
                  >
                    Principle
                  </Badge>
                  <Badge
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-slide-up">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              I offer a range of services designed to create user-friendly and
              visually stunning digital experiences. My goal is to combine
              creativity with functionality to help your team achieve its goals
      ...
      <section id="testimonials" className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-slide-up">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              I'm proud to have collaborated with some amazing clients. Here's
              what they have to say about our work together.
            </p>
          </div>
      ...
      <section id="contact" className="py-20 bg-neutral-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-slide-up">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              I'm excited to bring my skills and passion for design to a
              forward-thinking team. If you're looking for a dedicated designer
              who is ready to make an impact, I'd love to connect.
            </p>
          </div>
              ...
              <div className="space-y-6 mb-8">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:vickashshivan.designer@gmail.com"
                      className="text-muted-foreground hover:text-primary"
                    >
                      vickashshivan.designer@gmail.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex space-x-4">
                  ...
                  >
                    ...
                    >
                      ...
                      <path d="M8.56 2.75c4.37 6.03 6.02 9.42 8.03 17.72m2.54-15.38c-3.72 4.35-8.94 4.1-16.88 10.24"></path>
                    </svg>
                  </a>
                  <a
                    href="#"
