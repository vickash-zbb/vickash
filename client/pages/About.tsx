  ...
  const values = [
    {
      ...
      description:
        "Every design decision is made with the end user in mind. I believe great design solves real problems for real people.",
    },

    {
      ...
      description:
        "Pushing boundaries and exploring new possibilities to create unique and memorable experiences.",
    },

    {
      ...
      description:
        "Focusing on measurable outcomes and business goals while maintaining exceptional user experience.",
    },

    {
      ...
      description:
        "Continuous learning and attention to detail in every pixel, interaction, and user journey.",
    },
  ];
  ...
  const careerJourney = [
    {
      ...
      description:
        "Leading UI/UX initiatives and team development at a growing digital technology company. Overseeing design strategy, client relationships, and team expansion while delivering high-quality digital solutions.",
...

    {
      ...
      description:
        "Providing expert design consultation and strategy for innovative digital solutions. Focus on creating comprehensive design systems and conducting thorough user research to drive product success.",
...

    {
      ...
      description:
        "Contributed to design strategy and implementation for digital products. Specialized in creating user-centered design solutions and conducting comprehensive user research to optimize user experience.",
...

    {
      ...
      description:
        "Specialized in developing responsive user interfaces for fintech applications. Focused on performance optimization and creating seamless user experiences using modern web technologies.",
...

    {
      ...
      description:
        "Comprehensive program in UX/UI design and visual communication, covering modern design principles, user research methodologies, and industry-standard design tools and practices.",
...

    {
      ...
      description:
        "Bachelor's degree in Chemistry providing strong analytical and problem-solving skills that complement design thinking and user research methodologies.",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-slide-in-left">
              ...
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                ...
                creating intuitive, beautiful, and user-centered digital
                experiences. My mission is to bridge the gap between user needs
                and business goals through thoughtful design.
              </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-slide-up">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              From curious beginner to experienced designer, here's how I've
              grown and what drives my passion for creating exceptional user
              experiences.
            </p>
          </div>
          ...
          <div className="prose prose-lg max-w-none">
            <Card className="p-8 mb-8">
              <CardContent className="p-0">
                ...
                <p className="text-muted-foreground mb-4">
                  My journey into UI/UX design started with a simple
                  frustration: why were so many digital products difficult to
                  use? This curiosity led me to explore the world of user
                  experience design, where I discovered the perfect blend of
                  creativity, psychology, and problem-solving.
                </p>

                <p className="text-muted-foreground">
                  I began by teaching myself through online courses, design
                  books, and countless hours of practice. Every project taught
                  me something new about user behavior, visual hierarchy, and
            ...
            <Card className="p-8 mb-8">
              <CardContent className="p-0">
                ...
                <p className="text-muted-foreground mb-4">
                  ...
                  <strong> simplicity with purpose</strong>. I believe the best
                  designs are invisible to users – they accomplish their goals
                  effortlessly without having to think about the interface.
                </p>

                <p className="text-muted-foreground">
                  This philosophy guides every project I work on, from initial
                  research and wireframing to final pixel-perfect
                  implementations. I focus on understanding not just what users
            ...
            <Card className="p-8">
              <CardContent className="p-0">
                ...
                <p className="text-muted-foreground">
                  Today, I'm passionate about creating designs that make a real
                  difference in people's lives. Whether it's streamlining a
                  complex workflow, making an app more accessible, or helping a
                  business connect with their customers, I approach each project
                  with empathy, curiosity, and a commitment to excellence.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-slide-up">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              ...
              research and strategy to implementation and testing.
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-slide-up">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              The core principles that guide my approach to every design
              challenge.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-neutral-50 via-primary-50/30 to-neutral-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-slide-up">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              From analytical thinking to design leadership - every step shaped
          ...
          <div className="mb-12 animate-scale-in">
            <div className="text-center mb-8">
              <Badge
                variant="outline"
                className="text-primary border-primary/30 bg-primary/10 px-4 py-2 text-sm font-medium"
              >
                ...
                >
                  ...
                  <CardContent className="relative p-8 md:p-12">
                    <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
                      <div
                        className={`w-20 h-20 rounded-2xl bg-gradient-to-br ${item.gradient} p-0.5 shadow-lg`}
                      >
                          ...
                          <div className="lg:col-span-2">
                            ...
                            <div className="space-y-2">
                              {item.achievements.map((achievement, index) => (
                                ...
                                >
                                  <div
                                    className={`w-2 h-2 rounded-full bg-gradient-to-r ${item.gradient} mt-2 flex-shrink-0`}
                                  ></div>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {careerJourney
                .filter((item) => !item.featured && item.type === "work")
                .map((item, index) => (
                  <Card
                    key={item.id}
                    className={`group hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2 ${item.bgPattern} border-0 overflow-hidden animate-slide-up`}
                    style={{ animationDelay: `${index * 0.1}s` }}
                  >
                    <div
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-start justify-between mb-4">
                        <div
                          className={`w-12 h-12 rounded-xl bg-gradient-to-br ${item.gradient} p-0.5 shadow-lg group-hover:scale-110 transition-transform duration-300`}
                        >
                        ...
                        <div className="text-right">
                          <Badge
                            variant="outline"
                            className="text-xs border-primary/20 bg-white/50"
                          >
                            {item.year}
                          </Badge>
                        ...
                        <div className="space-y-1">
                          {item.achievements
                            ...
                            .map((achievement, achIndex) => (
                              ...
                              >
                                <div
                                  className={`w-1.5 h-1.5 rounded-full bg-gradient-to-r ${item.gradient} mt-1.5 flex-shrink-0`}
                                ></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {careerJourney
                ...
                .map((item, index) => (
                  <Card
                    key={item.id}
                    className="group relative overflow-hidden border-0 shadow-xl hover:shadow-2xl transition-all duration-700 transform hover:-translate-y-3 animate-slide-up"
                  ...
                  >
                    ...
                    <div
                      className={`relative h-20 bg-gradient-to-r ${item.gradient} p-4 flex items-center`}
                    >
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {item.technologies.map((tech, techIndex) => (
                            <Badge
                              key={techIndex}
                              className="bg-gradient-to-r from-blue-100 to-purple-100 text-blue-800 border-blue-200 text-xs"
                            >
                              {tech}
                            </Badge>
                          ))}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="animate-slide-up">
            ...
            <p className="text-lg text-muted-foreground mb-12 max-w-2xl mx-auto">
              ...
              contributing to design communities, and continuously learning
              about emerging trends in user experience.
            </p>
